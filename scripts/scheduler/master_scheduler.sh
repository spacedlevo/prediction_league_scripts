...
# Apply offseason overrides if OFFSEASON_MODE is enabled
if [[ "${OFFSEASON_MODE:-false}" == "true" ]]; then
    ENABLE_FETCH_RESULTS=${OFFSEASON_ENABLE_FETCH_RESULTS:-$ENABLE_FETCH_RESULTS}
    ENABLE_MONITOR_UPLOAD=${OFFSEASON_ENABLE_MONITOR_UPLOAD:-$ENABLE_MONITOR_UPLOAD}
    ENABLE_CLEAN_PREDICTIONS=${OFFSEASON_ENABLE_CLEAN_PREDICTIONS:-$ENABLE_CLEAN_PREDICTIONS}
    ENABLE_FETCH_FIXTURES=${OFFSEASON_ENABLE_FETCH_FIXTURES:-$ENABLE_FETCH_FIXTURES}
    ENABLE_AUTOMATED_PREDICTIONS=${OFFSEASON_ENABLE_AUTOMATED_PREDICTIONS:-$ENABLE_AUTOMATED_PREDICTIONS}
    ENABLE_FETCH_FPL_DATA=${OFFSEASON_ENABLE_FETCH_FPL_DATA:-$ENABLE_FETCH_FPL_DATA}
    ENABLE_FETCH_ODDS=${OFFSEASON_ENABLE_FETCH_ODDS:-$ENABLE_FETCH_ODDS}
    ENABLE_FETCH_PULSE_DATA=${OFFSEASON_ENABLE_FETCH_PULSE_DATA:-$ENABLE_FETCH_PULSE_DATA}
    ENABLE_FETCH_FPL_PICKS=${OFFSEASON_ENABLE_FETCH_FPL_PICKS:-$ENABLE_FETCH_FPL_PICKS}
    ENABLE_MYSQL_SYNC=${OFFSEASON_ENABLE_MYSQL_SYNC:-$ENABLE_MYSQL_SYNC}
fi
